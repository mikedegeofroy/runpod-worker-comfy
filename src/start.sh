...
if [ -d "/workspace/ComfyUI/models/insightface" ]; then
    echo "/workspace/ComfyUI/models/insightface directory exists."
    ...
    echo "/workspace/ComfyUI/models/insightface directory does not exist."
fi
